...
export function parseNodeVersion(nodeVersionSpec?: string): ComputeRuntime {
  ...
  // Extract version number from strings like ">=22.0.0", "^22.0.0", "22", "22.x", etc.
  ...
  // For older versions, default to nodejs22.x
  console.warn(`Node.js version ${nodeVersionSpec} is not supported. Defaulting to nodejs22.x`);
  return "nodejs22.x";
}
